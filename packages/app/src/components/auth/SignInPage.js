...
import { githubAuthApiRef, googleAuthApiRef, oauth2AuthApiRef, } from '@backstage/core-plugin-api';
export const SignInPage = () => {
    return (React.createElement(BackstageSignInPage, { title: "GitOps Management Portal", align: "center", providers: [
            {
